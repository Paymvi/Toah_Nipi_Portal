...
function DocumentCard({ document }) {
    ...
    function showDraftMessage() {
        alert("Draft only: later this button will open or download the real file from the server.");
    }
    return (<article className="document-card">
      ...
      <div className="document-actions">
        ...
        <button className="secondary-dashboard-button" type="button" onClick={showDraftMessage}>
        ...
        <button className="primary-dashboard-button" type="button" onClick={showDraftMessage}>
